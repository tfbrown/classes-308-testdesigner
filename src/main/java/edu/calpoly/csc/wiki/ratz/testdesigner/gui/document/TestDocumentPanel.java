...
public class TestDocumentPanel extends JFrame {
   ...
   public TestDocumentPanel() {
      ...
      answers = new ArrayList<Answer>();
      answers.add(new Answer("Phasellus accumsan, turpis at imperdiet lobortis, turpis libero congue felis,", false));
      answers.add(new Answer("Aliquam sed magna at lectus aliquet tincidunt in ac ante.", true));
      answers.add(new Answer("est enim euismod ipsum, nec dignissim ", false));
      answers.add(new Answer("pretium, elementum quis mi. Cras fermentum", false));
      mcItem.setAnswers(answers);
      controller.addItem(mcItem);
